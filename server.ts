...
Mantén el estilo profesional, ordenado con viñetas, sin explicaciones técnicas del código del bot, enfocado estrictamente en resultados empresariales.` + PROMPT_GUARD;

      const userPrompt = prompt || "Analiza mi situación del holding actual.";
